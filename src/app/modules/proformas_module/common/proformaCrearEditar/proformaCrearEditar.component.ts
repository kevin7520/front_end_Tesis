...
import { Cliente, proformaData } from '../../models/Response/obtenerProformasResponse';
...
@Component({
  selector: 'app-proformaCrearEditar',
  templateUrl: './proformaCrearEditar.component.html',
  styleUrls: ['./proformaCrearEditar.component.scss']
})
export class ProformaCrearEditarComponent implements OnInit, AfterViewInit {

  @Input() crearProforma: boolean = true;
  @Output() cancelar = new EventEmitter();
  @Output() creacionEdicion = new EventEmitter();
  @Input() proformaData!: proformaData;
 ...
 displayedColumns: string[] = 
  ...
  constructor(private proformaService: ProformaService, private _ServiciosService: ServiciosService, private notificationService: NotificationService, private pedidoService: PedidoService) { }
